   ...
   <div class="container student-subject-main">
        ...
        <form class="form-horizontal" action="tutor-addcourses.php" method="POST">
            <div class="form-group">
                <div class="row">
            <?php 
                $sql="SELECT * FROM `onlinetuitionmanagementsystem`.`class`";
                ...
                echo '<div class="col-md-3">
                    ...
                    $var=$row[$x-1]["class_id"];
                     $sql1="SELECT * FROM courses where class_id='$var';";
    ...
    <script>
        $(function() {
            ...
            $('input.Subjects1[type=checkbox]').change(function(e) {
                if ($('input.Subjects1[type=checkbox]:checked').length > 3) {
            ...
            $('input.Subjects2[type=checkbox]').change(function(e) {
                if ($('input.Subjects2[type=checkbox]:checked').length > 3) {
                    $(this).prop('checked', false)
                    alert("allowed only 3");
                }
            })
            ...
            $('input.Subjects3[type=checkbox]').change(function(e) {
                if ($('input.Subjects3[type=checkbox]:checked').length > 3) {
                    $(this).prop('checked', false)
                    alert("allowed only 3");
                }
            })
            ...
            $('input.Subjects4[type=checkbox]').change(function(e) {
                if ($('input.Subjects4[type=checkbox]:checked').length > 3) {
                    $(this).prop('checked', false)
                    alert("allowed only 3");
                }
            })
