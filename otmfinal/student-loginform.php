...
if($count == 1){
     if(($row["student_id"]==$student_id) && ($row["password"]==$spassword)){
        $_SESSION["student_id"] = $row["student_id"];
        $_SESSION["student_id_login"]=1;
        echo "Login Successful";
         header('Location: student-profile.php'); // default page
        } 
        ...
        echo 'window.location = "student-loginform.php"'   ;
        echo '</script>';
...
<body>
 ...
 <!-- Start of main content -->
    ...
    <div class="text-center">
        <h2 style="text-align: center; color: rgb(9, 13, 66);  padding-bottom: 20px;"><b> STUDENT LOGIN</b></h2>
        </div>
