...
$sql6="SELECT * from tutor_courses AS E join courses AS M ON E.course_id=M.course_id where tutor_id='$user'";
$result6=mysqli_query($conn,$sql6);
$sql7= "SELECT DISTINCT E.tutor_id, E.student_id,M.fname,M.lname FROM student_tutor as E join student as M on E.student_id = M.student_id where tutor_id='$user'";
$result7=mysqli_query($conn,$sql7);

$sql10="SELECT * from tutor_courses AS E join courses AS M ON E.course_id=M.course_id where tutor_id='$user'";
                    ...
                    <div class="modal-body">
                        ...
                        <form action="tutor-profile.php" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fnameEdit" id="fnameEdit">
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="snoEdit" id="snoEdit">
                                <label for="lnameEdit">Last Name</label>
                                <input type="text" class="form-control" name="lnameEdit" id="lnameEdit">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="numberEdit2" id="numberEdit2">
                            </div>
                            <div class="form-group">
                                <label for="qlfc_Edit">Qualification: </label>
                                <input type="text" class="form-control" name="qlfc_Edit" id="qlfc_Edit">
                            </div>
 ...
 <div class="modal fade" id="editModal3" role="dialog">
    <div class="modal-dialog">
            ...
            <div class="modal-body">
               <!-- Modal Body -->
                <form action="tutor-addcourses.php" method="POST">
                    <?php        
                     $sqlclass="SELECT * FROM `onlinetuitionmanagementsystem`.`class`";
                    ...
                    <div class="form-group">'; 
                        for ($xclass; $xclass <= $countclass; $xclass++){
                            ...
                            $addcourse="SELECT course_id,course_name,class_id FROM courses WHERE class_id='$class' AND course_id NOT IN (SELECT course_id FROM tutor_courses WHERE tutor_id='$user');";
        ...
        <table class="table table-bordered" id='myTable'>
            ...
            <tbody>
                <tr>
                    <!-- database se show krwa len with the help of mysqli_fetch_assoc -->
                    ...
                    <td> <button style=" background-color:#10102b; border-color:#10102b;" name='edit' class='edit btn btn-primary' id="">Edit</button>
                        <!-- iski id database se record ki id daal dena -->
        ...
        <div>
                    ...
                    <p style="font-size:120%;"><b>Amount: </b><?php echo $row['tutor_pay'];?></p>
