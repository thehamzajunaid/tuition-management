...
<div id="call-btn" class="visible-xs">
    ...
    <div id="main-content" class="container">
        <h2 style="text-align: center; color: rgb(9, 13, 66);  padding-bottom: 20px;"><b>EDUCATION IS IMPORTANT !</b></h2>
        ...
        <div id="home-tile" class="row">
            ...
            <div class="col-sm-6 col-md-4 col-sx-12">
                <a href="student-loginform.php">
                    <div id="covers-tile"><span>Student Login</span></div>
                </a>
            </div>
            <div class="col-sm-6 col-md-4 col-sx-12">
                <a href="tutor-loginform.php">
                    <div id="covers-tile"><span>Tutor Login</span></div>
                </a>
            </div>
