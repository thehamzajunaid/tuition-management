...
$sql5="SELECT * from student_courses AS E join courses AS M ON E.course_id=M.course_id where student_id='$user'";
...
$sql11= "SELECT DISTINCT E.tutor_id, E.student_id,M.fname,M.lname FROM student_tutor as E join tutor as M on E.tutor_id = M.tutor_id where student_id='$user'";
