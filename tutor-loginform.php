...
if($count == 1){
     if(($row["tutor_id"]==$tutor_id) && ($row["password"]==$tpassword)){
        $_SESSION["tutor_id"] = $row["tutor_id"]; 
        $_SESSION["tutor_id_login"]=1;
        echo "Login Successful";
         header('Location: tutor-profile.php'); // default page
        } 
        ...
        echo 'window.location = "tutor-loginform.php"'   ;
        echo '</script>';
 }}
        else{echo "error";}
?>
...
<body>
   <?php require '<partials/_header.php'?>
    ...
    <div class="container student-register-main">
        ...
        <h2 style="text-align: center; color: rgb(9, 13, 66);  padding-bottom: 20px;"><b>Tutor Login</b></h2>
        </div>
